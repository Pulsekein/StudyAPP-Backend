...
app.post("/tasks/:taskId/subtasks", async (req, res) => {
    ...
    try {
        ...
        const newSubtask = {
            title: name,
            superSubtask: [] // initialize empty array for super-subtasks
        };
...
// PATCH super-subtask (toggle complete or update comfort level)
...
// DELETE /tasks/:taskId/subtasks/:subtaskId/superTask/:superSubtaskId
...
// Assuming you have Task and Subtask schema set up properly
